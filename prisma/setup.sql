...
VALUES
    ('operator_' || gen_random_uuid()::text, 'operator@roboquill.io', 'Queue Operator', 'admin', CURRENT_TIMESTAMP),
    ('stuart_' || gen_random_uuid()::text, 'stuart@roboquill.io', 'Stuart', 'admin', CURRENT_TIMESTAMP)
